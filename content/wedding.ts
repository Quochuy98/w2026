...
export type AlbumSource = "imagekit" | "fallback";
...
export interface AlbumImage {
  /** Stable ImageKit file id or generated fallback id. */
  id: string;
  /** Public delivery URL (possibly transformed). */
  src: string;
  /** Original ImageKit URL, when available. */
  url?: string;
  /** Original ImageKit file path, when available. */
  path?: string;
  /** A thumbnail URL suitable for an admin/media-library preview. */
  thumbnail?: string;
  width: number;
  height: number;
  alt: string;
  ...
  layout: AlbumLayout;
  source: AlbumSource;
  /** ISO timestamp from ImageKit, when available. */
  updatedAt?: string;
  /** Optional low-quality placeholder generated by an image pipeline. */
  blurDataURL?: string;
}
...
export const weddingConfig: WeddingConfig = {
  ...
  imageKitFolder: "/wedding/thuong-huy/",
  seo: {
